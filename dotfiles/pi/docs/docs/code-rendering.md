...
Pi already highlights file-oriented tool output from the file extension. Normal command output remains plain text because stdout can mix logs, tables, diagnostics and several languages in one stream.
